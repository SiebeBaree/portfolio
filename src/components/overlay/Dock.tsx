...
const LINKS: DockLink[] = [
  {
    ...
    tile: (
      <span
        className="dock-tile"
        style={{ background: "linear-gradient(180deg, #67aef5 0%, #1f6bf0 100%)" }}
      >
        <svg
          aria-hidden
          viewBox="0 0 24 24"
  ...
  },
  {
    ...
    tile: (
      <span className="dock-tile" style={{ background: "#0a66c2" }}>
        <svg aria-hidden viewBox="0 0 24 24" style={{ width: "60%" }} fill="#ffffff">
  ...
  },
  {
    ...
    tile: (
      <span className="dock-tile" style={{ background: "#000000" }}>
        <svg aria-hidden viewBox="0 0 24 24" style={{ width: "52%" }} fill="#ffffff">
  ...
  },
  {
    ...
    tile: (
      <span
        className="dock-tile"
        style={{ background: "#ffffff", border: "1px solid rgb(28 41 90 / 0.08)" }}
      >
        <svg aria-hidden viewBox="0 0 24 24" style={{ width: "62%" }} fill="#1b1f24">
